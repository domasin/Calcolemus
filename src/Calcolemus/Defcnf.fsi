...
module Defcnf = 
    ...
    /// </summary>
    /// 
    /// <param name="fm">The formula to be transformed (supposed to be already in <see cref='M:Calcolemus.Prop.nenf``1'/>).</param>
    ...
    /// <summary>
    /// Used to define <see cref='M:Calcolemus.Defcnf.maincnf'/>.
    /// </summary>
    /// 
    ...
    /// <see cref='M:Calcolemus.Prop.nenf``1'/> and then it applies to the 
