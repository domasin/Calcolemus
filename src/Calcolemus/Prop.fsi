...
/// <see cref='T:Calcolemus.Prop.prop'/> for primitive propositions, most of 
/// the functions defined here for propositional logic are applicable (and 
/// intended to be applied) in general to any kind of 
/// <see cref='T:Calcolemus.Formulas.formula`1'/> and in particular 
/// to our specific type of first order logic formulas 
/// <see cref='T:Calcolemus.FolModule.fol'/>. These functions handle symbolic 
/// computation at the propositional level for any kind of 
/// <see cref='T:Calcolemus.Formulas.formula`1'/> unless the signature 
/// restricts them to the <see cref='T:Calcolemus.Prop.prop'/> type.
/// <p>
/// </p>
/// As remarked in the handbook, the defined type 
/// <see cref='T:Calcolemus.Prop.prop'/> for propositional variables is fixed 
...
module Prop = 
    ...
    /// <see cref='M:Calcolemus.Prop.print_truthtable'/>) and 
    /// <see cref='M:Calcolemus.Prop.tautology``1'/>
    /// </remarks>
    /// 
    ...
    /// 
    /// <remarks>
    /// See also <see cref='M:Calcolemus.Prop.print_truthtable'/>
    /// </remarks>
    /// 
    ...
    /// <see cref='M:Calcolemus.Prop.tautology``1'/> that, as this 
    /// function, is based on 
    /// <see cref='M:Calcolemus.Prop.onallvaluations``1'/>) when the result 
    /// column has <c>true</c> in each rows of the table; (ii) 
    /// <see cref='M:Calcolemus.Prop.satisfiable``1'/>, when the result colum 
    /// has <c>true</c> at least in one row; (iii) 
    /// <see cref='M:Calcolemus.Prop.unsatisfiable``1'/> when has 
    ...
    /// the one <see cref='M:Calcolemus.Intro.simplify1'/> applies on 
    ...
    /// applying <see cref='M:Calcolemus.Prop.psimplify``1'/> first 
    /// and then <see cref='M:Calcolemus.Prop.nnf_naive``1'/>.
    /// </remarks>
    /// 
    /// <param name="fm">The input formula.</param>
    /// 
    ...
    /// 
    /// <remarks>
    /// Applies <see cref='M:Calcolemus.Prop.psimplify``1'/> first 
    /// and then <see cref='M:Calcolemus.Prop.nenf_naive``1'/>.
    /// </remarks>
    /// 
    /// <param name="fm">The input formula.</param>
    /// 
    ...
    /// <see cref='M:Calcolemus.Prop.dnf_by_truth_tables``1'/>
    /// </remarks>
    /// 
    ...
    /// <summary>
    /// A close analogue of 
    /// <see cref='M:Calcolemus.Prop.onallvaluations``1'/> that collects 
    ...
    /// 
    /// <remarks>
    /// See <see cref='M:Calcolemus.Prop.dnf``1'/> for a definition of DNF.
    /// <p>
    /// </p>
    ...
    /// <c>\/</c> (see <see cref='M:Calcolemus.Prop.distrib_naive``1'/>) in 
    /// the context of a set of sets representation of dnf (see 
    /// <see cref='M:Calcolemus.Prop.purednf``1'/>)
    /// </remarks>
    /// 
