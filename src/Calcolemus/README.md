...
* to create an [api documentation](https://domasin.github.io/Calcolemus/reference/index.html)
...
* The name of the namespace has been changed to Calcolemus (Automated Reasoning in First Order Logic).
