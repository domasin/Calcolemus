...
module Unif = 
    ...
    /// directly. The call to <see cref='M:Calculemus.Unif.istriv'/> guarantees 
    ...
    /// mappings <c>env</c> returned by <see cref='M:Calculemus.Unif.unify'/>, 
    ...
    /// <see cref='M:Calculemus.Unif.unify'/> is specifically designed not to 
