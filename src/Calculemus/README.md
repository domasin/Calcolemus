...
* to create an [api documentation](https://domasin.github.io/Calculemus/reference/index.html)
...
* The name of the namespace has been changed to Calculemus (Automated Reasoning in First Order Logic).
