...
module Herbrand = 
    ...
    /// <see cref='M:Calculemus.Prop.eval``1'/> where the input propositional 
    ...
    /// <see cref='M:Calculemus.Herbrand.gilmore_loop'/>, 
    /// <see cref='M:Calculemus.Herbrand.dp_loop'/>, 
    /// <see cref='M:Calculemus.Herbrand.dp_refine_loop'/> for examples.
    /// </note>
    /// 
    ...
    /// <see cref='M:Calculemus.Herbrand.herbloop``2'/> specific for the 
    ...
    /// modification function <see cref='M:Calculemus.Herbrand.dp_mfn``2'/> and 
    /// using <see cref='M:Calculemus.DP.dpll``1'/> as test function.
    /// </remarks>
    /// 
    /// <param name="fl0">The input set of clauses.</param>
    /// <param name="cntms">The constant terms to generate the ground terms.</param>
    ...
    /// 
    /// <remarks>
    /// The difference with <see cref='M:Calculemus.Herbrand.dp_loop'/> is just 
    ...
    /// 
    /// <remarks>
    /// The difference with <see cref='M:Calculemus.Herbrand.davisputnam'/> is 
