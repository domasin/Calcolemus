...
module Skolem = 
    ...
    /// in the body).
    /// <p></p>
    /// It applies <see cref='M:Calculemus.Skolem.simplify1'/> repeatedly at 
    ...
    /// 
    /// <note>
    /// Pay attention that in <see cref='T:Calculemus.Prop'/> there is a 
    /// propositional version of <see cref='M:Calculemus.Prop.nnf``1'/>. If all 
    ...
    /// <see cref='M:Calculemus.Skolem.pullquants'/>.
    /// </summary>
    /// 
    /// <remarks>
    ...
    /// <summary>
    /// Auxiliary to <see cref='M:Calculemus.Skolem.skolem'/> when dealing with 
    /// binary connectives.
    /// </summary>
    /// 
    /// <remarks>
    ...
    /// <note>
    /// See also: 
    /// <seealso cref='M:Calculemus.Skolem.nnf``1'/>, 
    /// <seealso cref='M:Calculemus.Skolem.simplify'/>
    /// </note>
    /// 
