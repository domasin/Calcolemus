...
module Tableaux = 
    ...
    /// <summary>
    /// Tries to refute a set of <see cref='M:Calculemus.Skolem.askolemize'/>d 
    ...
    /// <see cref='M:Calculemus.Tableaux.tableau'/> procedure.
    /// </summary>
    /// 
    ...
    /// <see cref='M:Calculemus.Prop.simpdnf``1'/> is applied and, thus, 
    ...
    /// <see cref='M:Calculemus.Tableaux.tabrefute'/>.
    /// </remarks>
    /// 
    /// <param name="fm">The input formula</param>
    /// 
