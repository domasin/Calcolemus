...
module Defcnf = 
    ...
    /// </summary>
    /// 
    /// <param name="fm">The formula to be transformed (supposed to be already in <see cref='M:Calculemus.Prop.nenf``1'/>).</param>
    ...
    /// <summary>
    /// Used to define <see cref='M:Calculemus.Defcnf.maincnf'/>.
    /// </summary>
    /// 
    ...
    /// <see cref='M:Calculemus.Prop.nenf``1'/> and then it applies to the 
