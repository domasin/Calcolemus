...
module Fol = 
    ...
    /// 
    /// <remarks>
    /// It is similar to <see cref='M:Calculemus.Formulas.onatoms``1'/> 
    /// but specific for <see cref='T:Calculemus.Fol.fol'/> formulas.
    /// </remarks>
    /// 
    ...
    /// 
    /// <remarks>
    /// It is just a shortcut to call <see cref='P:Calculemus.Fol.parset'/>.
    /// </remarks>
    /// 
    /// <param name="s">The input string.</param>
    /// 
    ...
    /// 
    /// <remarks>
    /// It is just a shortcut to call <see cref='P:Calculemus.Fol.parse'/>. 
    /// </remarks>
    /// 
    /// <param name="s">The input string.</param>
    /// 
    ...
    /// variants.
    /// <p></p>
    /// It is use to define the <see cref='M:Calculemus.Fol.subst'/> quantified 
    /// formulas steps.
    /// </remarks>
    /// 
    /// <param name="subfn">The fpf that contains the mapping for the variables to replace.</param>
