...
module Intro =
    ...
    /// <see cref='M:Calculemus.Intro.simplify'/> that applies the rules at 
    ...
    /// 
    /// <remarks>
    /// Completes the work of <see cref='M:Calculemus.Intro.simplify1'/>.
    /// 
    /// Recursively simplifies any immediate sub-expressions as much as 
    /// possible, then applies <see cref='M:Calculemus.Intro.simplify1'/> 
    /// to the result.
    /// </remarks>
    /// 
    /// <param name="expr">The input expression.</param>
    ...
    /// 
    /// See also: <see cref='M:Calculemus.Intro.parse_expression'/>; 
    /// <see cref='M:Calculemus.Intro.parse_product'/>.
    /// </remarks>
    /// 
    ...
    /// cref='M:Calculemus.Intro.parse_atom'/>) separated by <c>*</c>.
    /// 
    /// See also: <see cref='M:Calculemus.Intro.parse_expression'/>.
    /// </remarks>
    /// 
    ...
    /// cref='M:Calculemus.Intro.parse_product'/>) separated by <c>+</c>.
    /// 
    /// See also: <see cref='M:Calculemus.Intro.parse_atom'/>.
    /// </remarks>
    /// 
    /// <param name="i">The tokenized string list to be parsed.</param>
    /// 
    ...
    /// See also: <see cref='M:Calculemus.Intro.parse_atom'/>; 
    /// <see cref='M:Calculemus.Intro.parse_product'/>; 
    /// <see cref='M:Calculemus.Intro.parse_expression'/>
    /// </remarks>
    /// 
    ...
    /// 
    /// Seealso: 
    /// <see cref='M:Calculemus.Intro.sprint_exp'/>; 
    /// <see cref='M:Calculemus.Intro.print_exp'/>;
    /// for clever versions.
    /// </remarks>
    /// 
    ...
    /// <see cref='M:Calculemus.Intro.sprint_exp'/> and 
    /// <see cref='M:Calculemus.Intro.print_exp'/>.
    ...
    /// 
    /// Seealso: 
    /// <see cref='M:Calculemus.Intro.string_of_exp'/>;
    /// <see cref='M:Calculemus.Intro.sprint_exp'/>.
    /// </remarks>
    /// 
    /// <param name="e">The expression to be translated.</param>
