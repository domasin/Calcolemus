...
/// <see cref='T:Calculemus.Intro'/> module and have been moved here 
...
module Lexer = 
    ...
    /// classifying predicates: <see cref='P:Calculemus.Lib.Lexer.space'/>, 
    /// <see cref='P:Calculemus.Lib.Lexer.punctuation'/>, 
    /// <see cref='P:Calculemus.Lib.Lexer.symbolic'/>, 
    /// <see cref='P:Calculemus.Lib.Lexer.numeric'/>, 
    /// <see cref='P:Calculemus.Lib.Lexer.alphanumeric'/>) and a list of 
