...
module DP =
    ...
    /// <summary>
    /// Resolves the input <c>clauses</c> on the literal which minimizes <see cref='M:Calculemus.DP.resolution_blowup``1'/>.
    /// </summary>
    /// 
    /// <param name="clauses">The input clauses.</param>
    /// 
    /// <returns>
    /// The result of resolving the input <c>clauses</c> on the literal which minimizes <see cref='M:Calculemus.DP.resolution_blowup``1'/>.
    /// </returns>
    /// 
    ...
    /// <see cref='M:Calculemus.DP.one_literal_rule``1'/>, 
    /// <see cref='M:Calculemus.DP.affirmative_negative_rule``1'/> and 
    /// <see cref='M:Calculemus.DP.resolution_rule``1'/>
    /// </remarks>
    /// 
    /// <param name="clauses">The input clauses.</param>
    /// 
    ...
    /// <see cref='M:Calculemus.DP.one_literal_rule``1'/>, 
    /// <see cref='M:Calculemus.DP.affirmative_negative_rule``1'/> and, if 
    /// neither of these is applicable (instead of 
    /// <see cref='M:Calculemus.DP.resolution_rule``1'/>) the <em>splitting 
    /// rule</em>.
    /// <p></p>
    ...
    /// <see cref='M:Calculemus.DP.posneg_count``1'/> is chosen for the 
    /// splitting rule.
    /// </remarks>
    /// 
    /// <param name="clauses">The input clauses.</param>
    ...
    /// 
    /// <seealso cref='M:Calculemus.DP.dpli``1'/>
    /// </summary>
    type trailmix =
        /// <summary>
