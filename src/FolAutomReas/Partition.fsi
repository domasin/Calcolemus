...
module Partition =
    ...
    /// <summary>
    /// Type of polymorphic 
    /// <see cref='T:FolAutomReas.Lib.Partition.partition`1'/>
    /// node.
    /// </summary>
    type pnode<'a> =
      /// <summary>
    ...
    type partition<'a> = 
      ...
      /// through an fpf (see <see cref='T:FolAutomReas.Lib.Fpf.func`2'/>) that 
      /// maps an element of the domain to a 
      /// <see cref='T:FolAutomReas.Lib.Partition.pnode`1'/>.
      /// </summary>
