...
module Formulas =
    ...
    /// 
    /// See also: <see cref='M:FolAutomReas.Formulas.antecedent``1'/>, 
    /// <see cref='M:FolAutomReas.Formulas.consequent``1'/>.
    /// </remarks>
    /// 
    ...
    /// 
    /// <remarks>
    /// See also: <see cref='M:FolAutomReas.Formulas.dest_imp``1'/>, 
    /// <see cref='M:FolAutomReas.Formulas.consequent``1'/>.
    /// </remarks>
    /// 
    ...
    /// <remarks>
    /// See also: <see cref='M:FolAutomReas.Formulas.dest_imp``1'/>, 
    /// <see cref='M:FolAutomReas.Formulas.antecedent``1'/>.
    /// </remarks>
    /// 
    /// <param name="fm">The input formula.</param>
    /// 
    ...
    /// 
    /// <remarks>
    /// It is for <see cref='T:FolAutomReas.Formulas.formula`1'/> what 
    ...
    /// <see cref='T:FolAutomReas.Formulas.formula`1'/> what 
